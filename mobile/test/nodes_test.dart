...
void main() {
  ...
  group('连线系统测试', () {
    test('创建连线', () {
      ...
      controller.startDrag('node1', 'output', const Offset(100, 100));
      controller.updateDrag(const Offset(200, 200));
    ...
    test('清空所有连线', () {
      ...
      controller.startDrag('node2', 'output', const Offset(200, 200));
  ...
  group('编辑器增强测试', () {
    test('搜索节点', () {
      AdvancedNodeTypes.registerAll();
      final controller = ConnectionController();
      final enhancements = EditorEnhancements(controller);
